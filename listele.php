...
<div class="container ">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
         ...
         <li class="nav-item">
            <a class="nav-link active" href="listele.php">Randevuları Listele</a>
         </li>
         <li class="nav-item">
      ...
      while($gelen=mysqli_fetch_array($cevap))
      {
          ...
          echo "<td>".$gelen['sikayet']."</td></tr></tbody>";
         
      }
      // tablo kodunu bitirelim.
      echo "</table>";
      echo "<h4 align='center'>Yeni kayıt eklemek için <a href='kayitformu.php'> Tiklayiniz</a>\n</h4>";
      ?>
   </div>
</body>
</html>