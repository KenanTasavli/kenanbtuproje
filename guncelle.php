...
method="POST">
            ...
            <div class="form-outline mb-4">
               ...
               <input type="text" value="<?php echo $gelen['ad']?>" name="ad" class="form-control form-control-lg"
            ...
            <div class="form-outline mb-3">
               ...
               <input type="text" value="<?php echo $gelen['soyad']?>" name="soyad" class="form-control form-control-lg"
               placeholder="Soyad Giriniz" />
            </div>

            <div class="form-outline mb-3">
               <label class="form-label" for="form3Example4">Telefon Numarası</label>
               <input type= "text" value="<?php echo $gelen['telno']?>" name="telno" class="form-control form-control-lg"
               placeholder="Telefon No Giriniz" />
            </div>

            <div class="form-outline mb-3">
               <label class="form-label" for="form3Example4">Tarih</label>
               <input type="date" value="<?php echo $gelen['tarih']?>" name="tarih" class="form-control form-control-lg"
               placeholder="Tarihi Giriniz" />
            </div>

            <div class="form-outline mb-3">
               <label class="form-label" for="form3Example4">Saat</label>
               <input type="time" value="<?php echo $gelen['saat']?>" name="saat" class="form-control form-control-lg"
               placeholder="Saati Giriniz" />
            </div>

            <div class="form-outline mb-3">
               <label class="form-label" for="form3Example4">Şikayet</label>
               <input type="text" value="<?php echo $gelen['sikayet']?>" name="sikayet" class="form-control form-control-lg"
